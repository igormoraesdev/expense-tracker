...
export const Header = () => {
  ...
  return (
    <header className="fixed sm:relative flex items-center justify-between md:justify-end w-full max-h-[100px] px-6 py-4 bg-white border-b-2 border-indigo-100">
