  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-bold text-indigo-200 capitalize",
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 font-normal bg-indigo-500/30 text-white hover:bg-indigo-700 hover:text-white"
        ),
        day_range_start: "day-range-start",
        day_range_end: "day-range-end",
        day_selected: "bg-indigo-700 text-white hover:bg-indigo-700",
        day_today: "bg-indigo-200 border border-indigo-200 text-white",
        day_outside:
