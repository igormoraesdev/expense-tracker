  ...
  return (
    <div className="w-full font-[sans-serif]">
      <div className="w-full min-h-screen flex flex-col items-center justify-center">
        <div className="grid md:grid-cols-2 items-center gap-4 max-md:gap-8 max-w-6xl max-md:max-w-lg w-full px-4 py-8 lg:m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
