...
export const FeaturesSection: React.FC<FeaturesSectionProps> = ({
  ...
  return (
    <section
      ref={recursosRef}
      id="recursos"
      className="mt-32 relative z-10 px-4 py-20 "
    >
      <motion.div
      ...
      >
        ...
        <p className="text-indigo-200 text-xl max-w-2xl mx-auto">
          Ferramentas completas para você gerenciar suas finanças com precisão e
          facilidade
        </p>
      </motion.div>
      <div className="grid md:grid-cols-3 gap-8">
        ...
        >
          ...
          <p className="text-indigo-200/80 mb-4 relative z-10">
            Defina objetivos e acompanhe seu progresso para alcançar a liberdade
            financeira.
          </p>
          <ul className="space-y-2 relative z-10">
            <li className="flex items-start gap-2 text-indigo-100 text-sm">
        ...
        >
          ...
          <p className="text-indigo-200/80 mb-4 relative z-10">
            Nunca mais esqueça de pagar uma conta ou fatura com nossos lembretes
            automáticos.
          </p>
          <ul className="space-y-2 relative z-10">
            <li className="flex items-start gap-2 text-indigo-100 text-sm">
